#ifndef CUDA_DISPLACEMENT_OP_H_
#define CUDA_DISPLACEMENT_OP_H_

#include <math.h>
#include <stdint.h>
#include "stdio.h"

class CudaDisplacementOp {
 public:
 	CudaDisplacementOp(uint32_t N, uint32_t num_boxes);
 	virtual ~CudaDisplacementOp();
